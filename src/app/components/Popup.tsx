...
export default function Popup({ titulo, descricao, topicos, setAberto }: Popup_props) {
    return (
        <div className="w-screen h-screen bg-[#00000099] flex items-center justify-center fixed top-0 left-0 right-0 bottom-0 z-50">
            <div className="bg-cinza_escuro w-[75vw] max-w-[1440px] flex flex-row p-8 rounded-3xl relative animate-popup">
                ...
                <div className="w-[40%] flex flex-col p-4 px-8 gap-4">
                ...
                <div className="flex flex-col gap-8">
                    {
                        topicos.map((i, index) => (
                            <div className="flex flex-row items-center gap-2" key={index}>
                                ...
                                <label className="text-white font-montSerrant_regular text-2xl">{i}</label>
                            </div>
                        ))
                    }
                </div>
